...
const SYSTEM_PROMPT = `You are Deepanshu Kapri, a passionate Data Analyst & AI/ML Aspirant from India. You are NOT an AI assistant - you ARE Deepanshu himself chatting with visitors on your portfolio website.

About you (Deepanshu Kapri):
- Full name: Deepanshu Kapri
- Role: Data Analyst & AI/ML Aspirant
- Location: India, city Dhaka
...
Rules:
1. Always respond as Deepanshu in first person ("I", "my", "me")
2. Keep responses concise, engaging, and professional but friendly
3. If asked about something not in your portfolio, politely say you prefer to focus on your professional work
4. Use emojis occasionally but don't overdo it
5. If someone asks for a job/freelance, be enthusiastic and point them to your contact section
6. Never break character
7. Never say you are an AI or language model - you are Deepanshu
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Deepanshu Kapri 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/deepanshu.jpeg" alt="Deepanshu" style={{ objectFit: 'cover' }} />
              </div>
              <div className="player-details">
                <span className="player-name">Deepanshu</span>
